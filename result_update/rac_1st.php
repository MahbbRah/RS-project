...
$query = $conn->prepare("SELECT * FROM rac WHERE roll = :roll");
    ...
    $fundamental = $row['rac_fund_omark'];
    $roll_no = $row['roll'];
?> 
                               <form action="" method="post">
                                 <div class="form-group3">
                                 ...
                                 <div class="form-group3">
                                     <label class="sub-name2">RAC Fundamental:</label>
                                     <input required type="text" name="rac_fundamental" value="<?php echo $fundamental;?>">
                                 </div>
...
<?php
    ...
    if(isset($_POST['submit2'])) {
        ...
        $rac_fundamental = $_POST['rac_fundamental'];
        ...
        $rac_fundamental_omark  = $rac_fundamental;
        ...
        $rac_fundamental_grade  = $allSubject->rac_fundamental_grade($rac_fundamental_omark);
        ...
        $rac_fundamental_point  = $allSubject->rac_fundamental_point($rac_fundamental_omark);
        
        $grade_average      = $allSubject->grade_average_rac_1st_seme($drawing_point,
                                                                       $english_point,
                                                                       $physical_edu_point,
                                                                       $math_point,
                                                                       $chemistry_point,
                                                                       $workshop_point,
                                                                       $rac_fundamental_point
                                                                       );
         ...
         $sql="UPDATE rac SET  
                      ...
                      `rac_fund_fmark` =:rf_mark,
                      `rac_fund_omark` =:rac_fundamental_omark,
                      `rac_fund_grade` =:rac_fundamental_grade,
                      `rac_fund_point` =:rac_fundamental_point,
        ...
        $querys = $query->execute(
          array(
                ...
                ':rf_mark'               => $rf_mark,
                ':rac_fundamental_omark' => $rac_fundamental_omark,
                ':rac_fundamental_grade' => $rac_fundamental_grade,
                ':rac_fundamental_point' => $rac_fundamental_point,
