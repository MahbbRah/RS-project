                 ...
                 <div class="all-content">
                     ...
                     <div class="col-md-8">
                         <div class="st-info-form">
                                 <h3 class="form-title">Update Result</h3>
                                 <div class="form-group33 l-height">
                                     ...
                                     <form method="post">
                                       <select id="tpi" onchange="javascript: submit()" class="form-control form-width">
                                         ...
                                         <option  value="com_1st.php">Computer Technology [ 1st Semester ]</option>
                                         <option  value="com_2nd.php">Computer Technology [ 2nd Semester ]</option>
                                         <option  value="com_3rd.php">Computer Technology [ 3rd Semester ]</option>
                                         <option  value="food_1st.php">Food Technology [ 1st Semester ]</option>
                                         <option  value="food_2nd.php">Food Technology [ 2nd Semester ]</option>
                                         <option  value="food_3rd.php">Food Technology [ 3rd Semester ]</option>
                                         <option  value="rac_1st.php">Rac Technology [ 1st Semester ]</option>
                                         <option  value="rac_2nd.php">Rac Technology [ 2nd Semester ]</option>
                                         <option  value="rac_3rd.php">Rac Technology [ 3rd Semester ]</option>
                                         <option  value="aidt_1st.php">Aidt Technology [ 1st Semester ]</option>
                                         <option  value="aidt_2nd.php">Aidt Technology [ 2nd Semester ]</option>
                                         <option  value="aidt_3rd.php">Aidt Technology [ 3rd Semester ]</option>
                                     </select>
                                     </form>
                                     <script>
