                         ...
                         <aside class="left-menu">
                             <ul class="nav">
                                <h3 class="menu-heading">Select Option</h3>
                                 <li><a href="student.php"><i class=" fa fa-user-plus"></i> Insert student</a></li>
                                 <li><a href="result_insert/index.php"><i class=" fa fa-plus-square"></i> Insert result</a></li>
                                 <li><a href=""><i class=" fa fa-file"></i> View result</a></li>
                                 ...
                                 <li><a href=""><i class=" fa fa-wrench"></i> Edit student</a></li>
                             </ul>
                         </aside>
                     </div>
