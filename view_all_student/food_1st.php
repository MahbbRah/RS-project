...
echo '	
				...
				<td>'.$sname.'</td>
				<td>'.$fname.'</td>
				<td><a href="../student_info_update/food.php?roll='.$roll.'" ><img src="edit.png" width="45" height="20"></a>				<a href="javascript:deleteStudent('.$roll.')"><img src="delete.png" width="45" height="20"></a></td>
			  </tr>
			'; 
...
<script type="text/javascript">
	function deleteStudent(roll)
	{
		...
		{
			window.location.href="food_1st.php?delete_roll="+roll;
		}
	}
</script>